...
void mystere(){
    ...
    if (zumba){
        do//boucle kap repeter a chaque fois que utilisateur la dit oui
        {
            ...
            melangus = melange(ligne);
                do
                {
                    ...
                    cin >> reponse;
                    if (reponse == ligne){
                        cout << "C'est exacte, felicitation !!!" << endl << endl;
                        compteur1++;
                        getch();
                        system("cls");
                    }
        ...
        cout << " Votre score est: " << compteur1 << " Bonne(s) reponse(s) " << " et " << compteur2 << " mauvaise(s) reponse(s)"<< endl;
    }
}
void nbr_mysterieux(){
    ...
    do
    {
        ...
        if (choix > nbr_aleatoire){
            ...
            cout << "Bravo, Vous avez trouvez" << endl << endl;
        }
...
int main(){
    ...
    do
    {
        ...
        case 3:
            ...
            break;
        default:
            cout << "Je n'ai pas compris essayer encore"<< endl;
            break;
        }
    }while (choice != 3);
